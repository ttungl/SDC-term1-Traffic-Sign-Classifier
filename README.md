...
There is a technique called [spatial transformer](https://github.com/kevinzakka/spatial-transformer-network), which allows the spatial manipulation of image within the network. This technique helps eliminate the white noise of the input images. I think this can be used later to improve the quality of the input image in my implementation. 
